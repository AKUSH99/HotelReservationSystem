                    ...
                    match choice:
                        ...
                        case "3":
                            ...
                            if not hotels:
                                ...
                                for hotel in hotels:
                                    print(f"Hotel ID: {hotel.id}, name: {hotel.name}, {hotel.stars} stars, address: {hotel.address.street}, {hotel.address.city}")
                                ...
                                for room in matching_rooms:
                                    if reservation_manager.is_room_available(room['Room Number'], room_hotel_id, start_date, end_date):
                                        ...
                                        print(f"Room No.: {room['Room Number']}, up to {room['Max Guests']} people, description: {room['Description']}, price per night: {room['Price']} Hotel: {hotel.name}, {hotel.address.city}")
                                ...
                                if not valid_room_numbers:
                                    ...
                                    while True:
                                        ...
                                        if room_number in valid_room_numbers:
                                            ...
                                            print(f"Invalid room number. Please choose from the available rooms: {', '.join(valid_room_numbers)}")
